...
// ? cmd->in_redirects.file_name : "None");
//             printf("Stop Heredoc: %s\n", cmd->in_redirects.stop_heredoc
				//!= NULL ? cmd->in_redirects.stop_heredoc : "None");
//             printf("New Heredoc File: %s\n",
					//cmd->in_redirects.new_heredoc_file != NULL
					//? cmd->in_redirects.new_heredoc_file : "None");
//         }     
...
//             printf("File Name: %s\n", cmd->out_redirects.file_name
					// != NULL ? cmd->out_redirects.file_name : "None");
//         }
...
// 		printf("[%d]: %s type: %s\n", i, token->str,
// 			token_type_names[token->type]); // casted to char
// 			// since in the first test we want to print a word
